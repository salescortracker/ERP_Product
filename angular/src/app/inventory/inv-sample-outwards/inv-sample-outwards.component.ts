...
@Component({
  selector: 'app-inv-sample-outwards',
  templateUrl: './inv-sample-outwards.component.html',
  styleUrls: ['./inv-sample-outwards.component.scss']
})
export class InvSampleOutwardsComponent implements OnInit {
