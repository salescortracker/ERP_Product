...
@Component({
  selector: 'app-inv-opening-stocks',
  templateUrl: './inv-opening-stocks.component.html',
  styleUrls: ['./inv-opening-stocks.component.scss']
})
export class InvOpeningStocksComponent implements OnInit {
public stores:any=[];
