...
@Component({
  selector: 'app-inv-losses-tra',
  templateUrl: './inv-losses-tra.component.html',
  styleUrls: ['./inv-losses-tra.component.scss']
})
export class InvLossesTraComponent implements OnInit {
  public tracode:number=102;
  public title:string='';
  ...
  public tradets:any;
    ...
    constructor(private inv:InvTransactionsService,private adm:AdminGeneralInfoService,
     private router:Router, private spinner:NgxSpinnerService) { 
      ...
      if(this.adm.screenCheck(3,2,this.menuCode,0))
      {
