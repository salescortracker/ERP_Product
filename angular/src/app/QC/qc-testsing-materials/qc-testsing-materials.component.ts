...
@Component({
  selector: 'app-qc-testsing-materials',
  templateUrl: './qc-testsing-materials.component.html',
  styleUrls: ['./qc-testsing-materials.component.scss']
})
export class QcTestsingMaterialsComponent implements OnInit {
typ:string='MAT';
screencode:number=1;
public tests:any;
public test:any={
