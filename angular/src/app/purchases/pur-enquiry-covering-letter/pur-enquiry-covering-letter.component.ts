...
@Component({
  selector: 'app-pur-enquiry-covering-letter',
  templateUrl: './pur-enquiry-covering-letter.component.html',
  styleUrls: ['./pur-enquiry-covering-letter.component.scss']
})
export class PurEnquiryCoveringLetterComponent implements OnInit {
public typ:string='PUR_ENQ';
public letter:any={
  Typ:this.typ,
  Subjec:'',
  Body:'',
