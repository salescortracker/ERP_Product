...
@Component({
  selector: 'app-pur-supplier-groups',
  templateUrl: './pur-supplier-groups.component.html',
  styleUrls: ['./pur-supplier-groups.component.scss']
})
export class PurSupplierGroupsComponent implements OnInit {
...
{
  this.delCheck=this.adm.screenCheck(2,1,1,3);
  this.authCheck=true;
    this.listAdd();
...
this.authCheck=false;
  ...
  {
    this.makeCle();
    this.creCheck=this.adm.screenCheck(2,1,1,1);
    this.saveStr='Save';
    this.opened=true;
  }
  private makeCle()
  ...
  openOld(obj:any)
  {
   ...
   if(obj.chk > 0)
   {
    ...
    this.creCheck=this.adm.screenCheck(2,1,1,2);
    this.saveStr='Modify';
    this.opened=true;
