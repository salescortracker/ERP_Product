...
import { ROUTES } from './hrd-menu-routes.config';
...
@Component({
  selector: 'app-hrd-menu',
  templateUrl: './hrd-menu.component.html',
  styleUrls: ['./hrd-menu.component.scss']
})
export class HrdMenuComponent implements OnInit {
...
public branchName:string;
  constructor(
    ...
    this.menuItems= ROUTES; //this.hrd.getHRDVericalMenuMake();
