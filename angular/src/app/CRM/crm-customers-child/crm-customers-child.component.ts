...
@Component({
  selector: 'app-crm-customers-child',
  templateUrl: './crm-customers-child.component.html',
  styleUrls: ['./crm-customers-child.component.scss']
})
export class CrmCustomersChildComponent implements OnInit {
  @Output()
...
public pricelists:any;
  ...
  constructor(private par:PartyDetailsService,private  cou:AdmCountriesService, private adm:AdminGeneralInfoService, 
    private spinner: NgxSpinnerService,private hrd:HrdEmployeesService,private crm:CrmRXPriceListService) {
    ...
    public changeCountry()
  {
    ...
    private valChk()
    {
     ...
     this.supplier.Employee= +this.supplier.Employee > 0?+this.supplier.Employee :null;
           Swal.fire({  
