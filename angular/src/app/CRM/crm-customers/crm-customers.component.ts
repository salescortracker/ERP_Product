...
public empdet:any={
  ...
  constructor(private adm:AdminGeneralInfoService,private modalService: NgbModal,
    ...
    private par:PartyDetailsService,private  cou:AdmCountriesService,private hrd:HrdEmployeesService
   ) {
    if(this.adm.screenCheck(7,1,4,0))
    {
      this.authCheck=true;
      this.delcheck=this.adm.screenCheck(7,1,4,3);
      this.listAdd();
      ...
      openNew()
      {
        this.crecheck=this.adm.screenCheck(7,1,4,1);
        this.makeCle();
   this.opened=true;
   this.recordid=0;
   this.savestr="Save";
   this.prevchk=true;
      ...
      openOld(obj)
      {
        ...
        this.crecheck=this.adm.screenCheck(7,1,4,2);
         this.recordid=obj.recordId;
         this.opened=true;
        this.savestr="Modify";
        this.empno=+obj.employee,
    ...
    private valChk()
    {
      ...
      public save()
      {
        if(this.valChk())
         ...
         this.supplier.Employee=+this.empno > 0? +this.empno:null;
