...
@Component({
  selector: 'app-crm-pre-rep-tele-calls-list',
  templateUrl: './crm-pre-rep-tele-calls-list.component.html',
  styleUrls: ['./crm-pre-rep-tele-calls-list.component.scss']
})
export class CrmPreRepTeleCallsListComponent implements OnInit {
