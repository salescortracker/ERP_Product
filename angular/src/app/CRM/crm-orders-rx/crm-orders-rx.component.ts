...
@Component({
  selector: 'app-crm-orders-rx',
  templateUrl: './crm-orders-rx.component.html',
  styleUrls: ['./crm-orders-rx.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class CrmOrdersRxComponent implements OnInit {
