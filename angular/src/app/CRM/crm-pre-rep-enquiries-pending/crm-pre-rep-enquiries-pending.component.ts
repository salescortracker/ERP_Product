...
@Component({
  selector: 'app-crm-pre-rep-enquiries-pending',
  templateUrl: './crm-pre-rep-enquiries-pending.component.html',
  styleUrls: ['./crm-pre-rep-enquiries-pending.component.scss']
})
export class CrmPreRepEnquiriesPendingComponent implements OnInit {
  public details:any;
  ...
  listAdd()
  {
    ...
    this.crm.getEnquiriesPending().subscribe(
      async res => {
        var det:any=res;
